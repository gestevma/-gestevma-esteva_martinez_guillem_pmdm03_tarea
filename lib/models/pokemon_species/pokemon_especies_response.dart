...
class PokemonEspeciesResponse {
  ...
  factory PokemonEspeciesResponse.fromRawJson(String str) =>
      PokemonEspeciesResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PokemonEspeciesResponse.fromJson(Map<String, dynamic> json) =>
      PokemonEspeciesResponse(
        ...
        name: json["name"],
        names: List<PokemonSpecieName>.from(
            json["names"].map((x) => PokemonSpecieName.fromJson(x))),
        order: json["order"],
...
class PokemonSpecieName {
  ...
  factory PokemonSpecieName.fromRawJson(String str) =>
      PokemonSpecieName.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PokemonSpecieName.fromJson(Map<String, dynamic> json) =>
      PokemonSpecieName(
        language: Color.fromJson(json["language"]),
        name: json["name"],
      );
